...
if __name__=="__main__":
    ...
    path_state_dict=r"E:\视觉\作业\作业6\densenet121-a639ec97.pth"
    ...
    if os.path.exists(path_state_dict):
        ...
        # 把模型改成densenet121加载预训练权重时出现问题，手动加载预训练权重出现报错，权重不匹配
        # 修改 key
    ...
    model.classifier = nn.Linear(num_ftrs, train_data.category)
